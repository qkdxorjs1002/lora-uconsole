from LoRa import LoRaSpi, LoRaGpio, BaseLoRa
...
class SX126x(BaseLoRa) :
    ...
    def __init__(self, spi: LoRaSpi, reset: LoRaGpio, busy: LoRaGpio, cs: Optional[LoRaGpio]=None, irq: Optional[LoRaGpio]=None, txen: Optional[LoRaGpio]=None, rxen: Optional[LoRaGpio]=None):
        self._spi = spi
        self._reset = reset
        self._busy = busy
        self._cs = cs
...
### COMMON OPERATIONAL METHODS ###
    ...
    def wake(self) :
        ...
        self._cs and self._cs.output(LoRaGpio.LOW)
        self._cs and time.sleep(0.0005)
        self.setStandby(self.STANDBY_RC)
        self._fixResistanceAntenna()
...
### SX126X API: UTILITIES ###
    ...
    def _writeBytes(self, opCode: int, data: tuple, nBytes: int) :
        ...
        self._cs and self._cs.output(LoRaGpio.HIGH)
